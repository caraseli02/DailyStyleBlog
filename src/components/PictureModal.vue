<template>
    <div name="modal" @keyup.left="previous" @keyup.right="next">
        <div class="overlay">
            ...
            <div class="view">
                <button class="btn close flex justify-center items-center" @click="close">☓</button>
                <div class="controls">
                    <button class="btn previous flex justify-center items-center" @click="previous">&#10094;
                    </button
                    >
                    <button class="btn next flex justify-center items-center" @click="next">&#10095;</button>
                </div>
